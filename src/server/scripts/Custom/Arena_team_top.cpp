...
class npc_arena_team_top : public CreatureScript
{
    public:
        ...
        {
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Ver top 10 2v2 Arena Teams", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Ver top 10 3v3 Arena Teams", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+2);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Ver top 10 5v5 Arena Teams", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+3);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Salir", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+4);
            ...
            if (sender == GOSSIP_SENDER_MAIN)
            {
                switch (actions)
                {
                    case GOSSIP_ACTION_INFO_DEF+1:
                    {
                        ...
                        Field * fields = NULL;
                        player->MonsterWhisper("|cffFFFF00Estos son Top 10 2v2 arena teams:|r", player);
                        do
                        {
                            fields = result->Fetch();
                    ...
                    case GOSSIP_ACTION_INFO_DEF+2:
                    {
                        ...
                        Field * fields = NULL;
                        player->MonsterWhisper("|cffFFFF00Estos son Top 10 3v3 arena teams:|r", player);
                        do
                        {
                            fields = result->Fetch();
                            string arena_name = fields[0].GetString();
                    ...
                    case GOSSIP_ACTION_INFO_DEF+3:
                    {
                        ...
                        Field * fields = NULL;
                        player->MonsterWhisper("|cffFFFF00Estos son Top 10 5v5 arena teams:|r", player);
                        do
                        {
                            fields = result->Fetch();
                            string arena_name = fields[0].GetString();
